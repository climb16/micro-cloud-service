package online.jfree.micro.cloud.server.oauth.entity;
...
public class RcMenuEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (pCode != null ? !pCode.equals(that.pCode) : that.pCode != null) {
            return false;
        }
        ...
        if (isMenu != null ? !isMenu.equals(that.isMenu) : that.isMenu != null) {
            return false;
        }
